...
public class PhoneCapability extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View rootView = inflater.inflate(R.layout.activity_start_page, container, false);
        ...
        Button musicButtonIntent = (Button) getActivity().findViewById(R.id.musicButton);
...
//                getNearbyBusinesses("movies");
    ...
    public String getYelpResults() {
        ...
        if (mLastLocation != null) {
            ...
            request.addQuerystringParameter("term", "books");
